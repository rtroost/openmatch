			...
			<div class="row-fluid">
				...
				<div id="frontpage-about_us_block">
					...
					<div class="span12">
						...
						<p>
							Op de website van Rotterdam Onbeperkt vindt u alle uitgaansgelegenheden van Rotterdam en zijn mede mogelijk gemaakt door de <a href="http://www.rotterdamopendata.nl/" target="_blank">Rotterdam Open Data Store</a>. Rotterdam Onbeperkt is ontwikkeld om minder valide mensen een handvat te geven om te kunnen bepalen welke uitgaansgelegenheden in Rotterdam rolstoelvriendelijk zijn. Via deze website kunt u beoordelingen en reacties over alle uitgaansgelegenheden lezen. Uiteraard kunt u zelf ook meedoen en een beoordeling of reactie achterlaten!
						</p>
						<p>
							Door middel van Rotterdam Onbeperkt kunt u profiteren van de ervaringen van anderen en tevens uw eigen ervaring overbrengen. Via deze website kunt u eenvoudig een keuze maken als u bijvoorbeeld een dagje uit wilt of ergens wat wil gaan eten.
						</p>
						<p>
