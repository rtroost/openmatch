						...
						<ul class="unstyled" id="locationfilter" >
							<li>
								<label class="checkbox">
									<input type="checkbox" name="bibliotheken" value="bibliotheken"> Bibliotheken
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="bioscopen" value="bioscopen"> Bioscopen
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="campings" value="campings"> Campings
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="sportgelegenheden" value="sportgelegenheden"> Sportgelegenheden
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="kinderboerderijen" value="kinderboerderijen"> Kinderboerderijen
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="kindervermaak" value="kindervermaak"> Kindervermaak
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="theaters" value="theaters"> Theaters
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="recreatieterreinen" value="recreatieterreinen"> Recreatieterreinen
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="zwembaden" value="zwembaden"> Zwembaden
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="musea" value="musea"> Musea
								</label>
							</li>
							<li>
								<label class="checkbox">
							...
							<li>
								<label class="checkbox">
									<input type="checkbox" name="dierentuin" value="dierentuin"> Dierentuin
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="attracties" value="attracties"> Attracties
								</label>
							</li>
							<li>
								<label class="checkbox">
									<input type="checkbox" name="speeltuinen" value="speeltuinen"> Speeltuinen
								</label>
							</li>
						</ul>
					</div><!--/sidebar_block-->
